...
public class Intialization {
    ...
    public static FacultyDirectory facultyDirectory;
     ...
     Student student3 =department1.getStudentDirectory().addStudent("Suresh", "1236", "2014", "IS","2","2");
     Student student4 =department1.getStudentDirectory().addStudent("Frank", "1290", "2015", "IS","3","1");
     Student student9 =department1.getStudentDirectory().addStudent("Pradeep", "1200", "2014", "IS","3","1");
    
     Student student5 =department2.getStudentDirectory().addStudent("Mahesh", "1237", "2014", "EM","2","2");
     Student student6 =department2.getStudentDirectory().addStudent("Yokesh", "1238", "2014", "EM","3","1");
     Student student7 =department2.getStudentDirectory().addStudent("Pranesh", "1239", "2014", "EM","2","1");
     ...
     Student student12 =department3.getStudentDirectory().addStudent("Madev", "2101", "2014", "CSE","3","1");
     Student student13 =department3.getStudentDirectory().addStudent("Eswar", "2102", "2014", "CSE","3","2");
     Student student14 =department3.getStudentDirectory().addStudent("Lohesh", "2103", "2014", "CSE","3","2");
     Student student15 =department3.getStudentDirectory().addStudent("Ajay", "2004", "2104", "CSE","4","2");
     ...
     Student student19=department4.getStudentDirectory().addStudent("Catick", "4204", "2015", "Finance","3","1");
     Student student20 =department4.getStudentDirectory().addStudent("Orlick", "4205", "2014", "Finance","3","2");
     ...
     Student student29 =department6.getStudentDirectory().addStudent("Praquet", "5005", "2104", "Human Resource","1","1");
     ...
     Student student33=department7.getStudentDirectory().addStudent("Rahul", "4604", "2015", "Physics","1","1");
     Student student34 =department7.getStudentDirectory().addStudent("Yamesh", "4605", "2014", "Physics","1","1");
     ...
     Student student44 =department9.getStudentDirectory().addStudent("Utam", "5106", "2104", "Chemistry","2","1");
     
     Alumini alumini25 =department7.getAluminiDirectory().addAlumini("4600", "NASA", "Working","120000", "2016");
     Alumini alumini26 =department7.getAluminiDirectory().addAlumini("4601", "British Airways", "Working","100000", "2016");
     Alumini alumini27 =department7.getAluminiDirectory().addAlumini("4603", "", "Not-Working","", "2016");
     Alumini alumini28 =department7.getAluminiDirectory().addAlumini("4604", "Indian Airways", "Working","95000", "2016");
     
     Alumini alumini29 =department8.getAluminiDirectory().addAlumini("3600", "Oracle", "Working","90000", "2016");
     Alumini alumini30 =department8.getAluminiDirectory().addAlumini("3602", "MIT", "Working","120000", "2016");
     ...
     Alumini alumini1 =department1.getAluminiDirectory().addAlumini("1234", "IBM", "Working","120000", "2016");
     Alumini alumini2 =department1.getAluminiDirectory().addAlumini("1236", "ORACLE", "Working","140000", "2016");
     Alumini alumini3 =department1.getAluminiDirectory().addAlumini("1235", "", "Not-Working","", "2016");
     Alumini alumini4 =department1.getAluminiDirectory().addAlumini("1200", "Google", "Working","130000", "2016");
    
     Alumini alumini5 =department2.getAluminiDirectory().addAlumini("1238", "NIKE", "Working","90000", "2016");
     Alumini alumini6 =department2.getAluminiDirectory().addAlumini("1239", "DISNEY", "Working","100000", "2016");
     ...
     Alumini alumini9 =department3.getAluminiDirectory().addAlumini("2100", "Facebook", "Working","120000", "2016");
     Alumini alumini10 =department3.getAluminiDirectory().addAlumini("2101", "Yahoo", "Working","100000", "2016");
     Alumini alumini11=department3.getAluminiDirectory().addAlumini("2102", "Piki", "Working","90000", "2016");
     Alumini alumini12=department3.getAluminiDirectory().addAlumini("2104", "Apple", "Working","140000", "2016");
     
     Alumini alumini33=department9.getAluminiDirectory().addAlumini("5101", "T-Labs", "Working","80000", "2016");
     Alumini alumini34 =department9.getAluminiDirectory().addAlumini("5102", "Q-Labs", "Working","70000", "2016");
     Alumini alumini35=department9.getAluminiDirectory().addAlumini("5103", "S-Labs", "Working","100000", "2016");
     Alumini alumini36=department9.getAluminiDirectory().addAlumini("5104", "K-Labs", "Working","130000", "2016");
     
     Alumini alumini13 =department4.getAluminiDirectory().addAlumini("4200", "Bank Of America", "Working","90000", "2016");
     Alumini alumini14 =department4.getAluminiDirectory().addAlumini("4201", "Santander", "Working","100000", "2016");
     Alumini alumini15 =department4.getAluminiDirectory().addAlumini("4202", "", "Not-Working","", "2016");
     Alumini alumini16 =department4.getAluminiDirectory().addAlumini("4203", "Bank of New York", "Working","110000", "2016");
    
       
     
     Alumini alumini17 =department5.getAluminiDirectory().addAlumini("3100", "Addidas", "Working","80000", "2016");
     Alumini alumini18 =department5.getAluminiDirectory().addAlumini("3102", "Ray-Bon", "Working","100000", "2016");
     ...
     Alumini alumini21=department6.getAluminiDirectory().addAlumini("5001", "Amazon", "Working","130000", "2016");
     Alumini alumini22 =department6.getAluminiDirectory().addAlumini("5002", "ARM", "Working","110000", "2016");
     Alumini alumini23=department6.getAluminiDirectory().addAlumini("5003", "Intel", "Working","100000", "2016");
     Alumini alumini24=department6.getAluminiDirectory().addAlumini("5004", "Verizon", "Working","130000", "2016");
      ...
      //CourseSchedule courseSchedule1= course1.getCourseScheduleDirectory().addCourseSchedule(classRoom1, faculty1, courseOffering1);
      //addCourse("AED", "C234", "4", "1000");
...
CourseSchedule courseSchedule1= course1.getCourseScheduleDirectory().addCourseSchedule(classroom9, faculty9, courseOffering1);
    Seat seat1 = student1.getSeatDirectory().addSeat(courseSchedule1, 3);
     ...
     Transcript transcript1= student1.getTranscriptDirectory().addTranscript(courseload1);
    ...
    Seat seat2 = student1.getSeatDirectory().addSeat(courseSchedule2, 4);
     ...
     Transcript transcript2= student1.getTranscriptDirectory().addTranscript(courseload2);
    ...
    Seat seat3 = student1.getSeatDirectory().addSeat(courseSchedule2, 3);
     ...
     Transcript transcript3= student1.getTranscriptDirectory().addTranscript(courseload3);
    ...
    Seat seat4 = student1.getSeatDirectory().addSeat(courseSchedule1, 2);
     ...
     Transcript transcript4= student1.getTranscriptDirectory().addTranscript(courseload4);
    ...
    Seat seat5 = student2.getSeatDirectory().addSeat(courseSchedule2, 4);
     ...
     Transcript transcript5= student2.getTranscriptDirectory().addTranscript(courseload5);
    ...
    Seat seat6 = student2.getSeatDirectory().addSeat(courseSchedule1, 2);
     ...
     Transcript transcript6= student2.getTranscriptDirectory().addTranscript(courseload6);
    ...
    Seat seat7 = student3.getSeatDirectory().addSeat(courseSchedule1, 3);
     ...
     Transcript transcript7= student3.getTranscriptDirectory().addTranscript(courseload7);        
    ...
    Seat seat8 = student3.getSeatDirectory().addSeat(courseSchedule1, 4);
     ...
     Transcript transcript8= student3.getTranscriptDirectory().addTranscript(courseload8);
    ...
    Seat seat9 = student4.getSeatDirectory().addSeat(courseSchedule6, 3);
     ...
     Transcript transcript9= student4.getTranscriptDirectory().addTranscript(courseload9);
    ...
    Seat seat10 = student4.getSeatDirectory().addSeat(courseSchedule2, 4);
     ...
     Transcript transcript10= student4.getTranscriptDirectory().addTranscript(courseload10);
    ...
    Seat seat11 = student9.getSeatDirectory().addSeat(courseSchedule1, 3);
     ...
     Transcript transcript11= student9.getTranscriptDirectory().addTranscript(courseload11);
    ...
    Seat seat12 = student9.getSeatDirectory().addSeat(courseSchedule1, 3);
     ...
     Transcript transcript12= student9.getTranscriptDirectory().addTranscript(courseload12);
