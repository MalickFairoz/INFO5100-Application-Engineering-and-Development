...
public class CustomerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public CustomerWorkAreaJPanel(JPanel userProcessContainer, SupplierDirectory supplierDirectory, MasterOrderCatalog moc) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        BrowseProducts bp = new BrowseProducts(userProcessContainer, supplierDirectory, moc);
        userProcessContainer.add("BrowseProduct", bp);
